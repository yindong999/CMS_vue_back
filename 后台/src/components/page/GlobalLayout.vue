...
<style lang="scss">
  body {
    ...
    font-family: -apple-system, BlinkMacSystemFont,'Noto Sans SC', 'Segoe UI', 'PingFang SC', 'Hiragino Sans GB', 'Microsoft YaHei', 'Helvetica Neue', Helvetica, Arial, sans-serif, 'Apple Color Emoji', 'Segoe UI Emoji', 'Segoe UI Symbol' !important;
  ...
  .layout {
    ...
    //内容区在导航栏改为160px后的padding-left也改为160px
    .content-width-Fixed{
