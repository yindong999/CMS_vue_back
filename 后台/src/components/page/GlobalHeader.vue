<template>
  ...
  <a-layout-header
    v-if="!headerBarFixed"
    :class="[fixedHeader && 'ant-header-fixedHeader','top_head', sidebarOpened ? 'ant-header-side-opened' : 'ant-header-side-closed', ]"
    :style="{ padding: '0' }"
  >
    ...
    <!-- 顶部导航栏模式 -->
    <div v-else :class="['top-nav-header-index header', theme]">
